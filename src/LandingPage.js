...
export default function LandingPage() {
    return( 
        <>
            ...
            <main>
                <h2>Primeiramente vamos entender o que é criatividade</h2>
                <p>
                ...
                <h2>Porque você que é um desenvolvedor precisa dessa soft skill?</h2>
                <p>
                    Se você é um dev a criatividade faz parte de uma das habilidades fundamental para resolvermos novos problemas que iram surgir no decorrer da nossa vida como programadores e conseguir criar novas soluções.
                </p>
                <p>
